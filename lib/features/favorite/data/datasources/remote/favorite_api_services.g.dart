...
part of 'favorite_api_services.dart';
...
class _FavoriteApiServices implements FavoriteApiServices {
  _FavoriteApiServices(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<List<FavoriteModel>> getFavorite() async {
    ...
    final _options = _setStreamType<List<FavoriteModel>>(
